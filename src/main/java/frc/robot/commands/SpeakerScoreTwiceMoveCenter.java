...
public class SpeakerScoreTwiceMoveCenter extends SequentialCommandGroup {
  /** Creates a new Auto1. */
  Shooter m_shooter;
  ...
  public SpeakerScoreTwiceMoveCenter(DriveSubsystem drive, Shooter shooter, Harvester harvester) {
    ...
    addCommands(
        ...
        new SetIntakeSpeed(m_harvester, Constants.harvesterConstants.inSpeed),
        ...
        new GoToCommand(m_robotDrive, SpeakerPos),
        new SetArmAngleCommand(m_harvester, speakerAngle),
        new ShootCommand(m_shooter, m_harvester),
        new GoToCommand(m_robotDrive, FromCenterStartToCenterRing)
