...
public class SpeakerScoreTwiceStageSideBlue extends SequentialCommandGroup {
  /** Creates a new Auto1. */
  Shooter m_shooter;
  ...
  public SpeakerScoreTwiceStageSideBlue(DriveSubsystem drive, Shooter shooter, Harvester harvester) {
