...
public class SpeakerScoreTwiceCenter extends SequentialCommandGroup {
  /** Creates a new Auto1. */
  Shooter m_shooter;
  ...
  public SpeakerScoreTwiceCenter(DriveSubsystem drive, Shooter shooter, Harvester harvester) {
