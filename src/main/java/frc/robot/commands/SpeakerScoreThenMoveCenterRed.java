...
public class SpeakerScoreThenMoveCenterRed extends SequentialCommandGroup {
  /** Creates a new Auto1. */
  Shooter m_shooter;
  ...
  public SpeakerScoreThenMoveCenterRed(DriveSubsystem drive, Shooter shooter, Harvester harvester) {
