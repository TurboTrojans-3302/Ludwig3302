...
public class Shooter extends SubsystemBase {
  ...
  private Double mSetpoint, mSetpointRight, mSetpointLeft, mLeftVelocity, mRightVelocity, speedMultiplier;
  private AnalogInput mUltrasonicInput;
  private DigitalInput mUltrasonicPin;
  
  
  private ShuffleboardTab mShuffleboardTab;
  private GenericEntry mSetpointEntry, mSetpointLeftEntry, mSetpointRightEntry, mLeftErrEntry, mRightErrEntry,
  ...
  public Shooter() {
    ...
    mUltrasonicPin = new DigitalInput(0);
    

    mUltrasonicPin.notify();

    speedMultiplier = Constants.ShooterConstants.speedMultiplier;
    // PID coefficients
    kP = 0.002; 
    kI = 0.0;
    kD = 0.0; 
    ...
    mSetpoint = 0.0;
    mSetpointRight = mSetpoint;
    mSetpointLeft = mSetpoint;
    mLeftVelocity = 0.0;
    mRightVelocity = 0.0;
    ...
    mSpeedReadyEntry = mShuffleboardTab.add("ShooterReady", speedIsReady())
                                       ...
                                       .getEntry();
    mSetpointEntry = mShuffleboardTab.add("Original Setpoint", mSetpoint).getEntry();
    mSetpointLeftEntry = mShuffleboardTab.add("Left Setpoint", mSetpointLeft).getEntry();
    mSetpointRightEntry = mShuffleboardTab.add("Right Setpoint", mSetpointRight).getEntry();
  ...
  public void periodic() {
    ...
    double rightOutput = mRightPidController.calculate(mRightVelocity, mSetpointRight);
    double leftOutput = mLeftPidController.calculate(mLeftVelocity, mSetpointLeft);
    ...
    mSetpointLeftEntry.setDouble(mSetpointLeft);
    mSetpointRightEntry.setDouble(mSetpointRight);
  ...
  public double increaseSetpointRight(boolean DPAD){
    mSetpointRight += mSetpoint * speedMultiplier;
    return mSetpointRight;
  }

  public double increaseSetpointLeft(boolean DPAD){
    mSetpointLeft += mSetpoint * speedMultiplier;
    return mSetpointLeft;
}
}
